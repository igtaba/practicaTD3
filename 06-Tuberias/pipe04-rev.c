...
int main ()
{
	...
	//close(ipc[0]);		//This closing of the reading descrpitor made it impossible to read it later
   
	switch (fork())
	{ 

		case 0:		//What the Son is executing
		close(ipc[1]);		//Closing the writing descriptor
		...
		default:		//What the Father is executing
